...
RUN docker-php-ext-install mbstring xml gd zip pcntl sockets bcmath pdo pdo_mysql soap 
RUN docker-php-ext-enable mbstring xml gd zip pcntl sockets bcmath pdo pdo_mysql soap swoole
